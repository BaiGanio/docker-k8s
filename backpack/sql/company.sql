-------------------------------------------------------------------
-- This script will create a sample database "TechCorp" in     --
-- MS SQL Server and will populate sample data in its tables.    --
-- Script works for local instances only!                        --
-------------------------------------------------------------------
-- Create the database [Geography] if it does not exist
IF NOT EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = 'TechCorp')
