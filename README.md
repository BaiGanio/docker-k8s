...
📦 unkindled         # .NET projects used in the challenges
 ...
 ┃  ┃  ┗ 📁 c1/
 ┃  ┃     ┣ 📄 HelpMe.cs          # Gemstone
 ┃  ┃     ┗ 📄 Planet.cs.         # Celestial object
 ┃  ┣ 🐳 docker/
 ┃  ┃  ┣ 📄 docker-compose.yaml   # MSSQL Server with DBs
...
Open a pull request and let your contribution be judged by the Firekeepers.
 ...
 <p align="center">
  Please read the full guidelines here: <a href="https://github.com/BaiGanio/docker-k8s/tree/master?tab=contributing-ov-file">[👉 CONTRIBUTING.md]</a>
</p>
 <p align="center" style="font-size: 90%; opacity: 0.7;">
  [<a href="#top">Back to top ↑</a>]
</p>
